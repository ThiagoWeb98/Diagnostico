          ...
          <div className="relative w-full max-w-[580px]">
            <div className="glass-dark rounded-3xl shadow-[0_50px_100px_rgba(0,0,0,0.5)] p-12 lg:p-16 relative overflow-hidden border border-[#c5a368]/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button type="button" onClick={() => window.open('https://bnrfxmop3u8.typeform.com/to/BRLBKgfi', '_blank')} className="w-full bg-blend-niche text-[#0b090c] py-7 rounded-full font-bold uppercase tracking-[0.5em] text-[11px] shadow-[0_20px_40px_rgba(197,163,104,0.3)] hover:shadow-[0_25px_60px_rgba(197,163,104,0.5)] transition-all transform hover:scale-[1.02] active:scale-95 group relative overflow-hidden mt-6">
